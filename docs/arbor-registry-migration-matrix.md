...
| systemd-vaultd delivery | systemd-vaultd provider | NixOS credential binding contract | Initial fetch/readiness + watcher boundary implemented | Upstream vaultd socket/JSON contract remains external |
