...
| REMOTE-MAIN-PROMOTION | DONE | standalone component sync | lead + worker | arbor-manager `a9fa0de`, arbor-registry `f53dbe7`; root lock refreshed and normal remote checks passed |
